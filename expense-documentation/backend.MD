...
Install NodeJS, By default NodeJS 16 is available, We would like to enable 20 version and install this as developer menctioned.
...
```
curl -o /tmp/backend.zip <Backend code base>
```
```
cd /app
```
...
We need to setup a new service in systemd thus, systemctl can manage this service
...
**NOTE: Ensure you replace <MYSQL-SERVER-IPADDRESS> with private IP address**
